...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('files/css/adn.css') }}">
        ...
        <main class="py-4">
            <section class="login-block">
                <div class="container">
                    <div class="row">
                        <div class="col-sm-12">
                            <form class="md-float-material form-material" method="POST" id="frm" action="{{ url('aman/validasi') }}" role="form" onsubmit="return submited()">
                            @csrf
                                <div class="text-center">
                                    <img src="{{ asset('img/iconptpn.png') }}" alt="Logo PT. Perkebunan Nusantara XII">
                                </div>
                                <div class="auth-box card">
                                    <div class="card-block">
                                        <div class="text-center">
                                            <div class="text-center" style="margin-bottom: 40px;">
                                                <img src="{{ asset('img/blacklogo.png') }}" alt="Logo Si Tata Kelola Dokumen">
                                            </div>
                                        </div>
