...
<main class="main-content">
    <div class="w-full md:w-1/2 md:mx-auto p-20 border-custom rounded bg-white md:mt-32 md:mb-24 text-center">
        ...
        <div class="form-group">
            <input class="bg-gray-custom border-custom p-5 text-center mb-3 w-full text-black" value="{{ url('/') }}?ref={{ Session::get('UserFundraiserCode') }}" placeholder="" id="InputCopy" readonly="">
        </div>
        ...
        <ul class="bg-gray-custom text-left text-sm border-custom">
            <li class="flex p-4 border-b-custom">
                ...
                <div class="w-1/3 text-right">{{ $donate->Hits }}</div>
            </li>
            <li class="flex p-4 border-b-custom">
                <div class="w-2/3">
                    <svg class="inline-block mr-2" width="15" height="15" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="w-1/3 text-right">{{ $donate->CountFormInput }}</div>
            </li>
            <li class="flex p-4">
                <div class="w-2/3">
                    <svg class="inline-block mr-2" width="15" height="15" fill="none" xmlns="http://www.w3.org/2000/svg">
