...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{ route('polamakan.create.step.one.post') }}" method="POST">
            @csrf
            <!-- 1 -->
            <div class="form-group mb-4">
                <label>Dalam satu minggu terakhir, berapa kali Anda mengonsumsi buah-buahan segar per hari?</label>
                <div class="input-group">
                    <input type="number" id="Buah" name="Buah" class="form-control" value="{{ $data->Buah ?? '' }}" autocomplete="off" required>
            ...
            <div class="form-group mb-4">
                ...
                <div class="mx-auto">
                    <img src="{{ url('img/assets/isi-piringku-buah-buahan.jpg') }}" alt="isi piringku porsi buah-buahan" class="mw-100" />
                </div>
                {!! Form::select('PorsiBuah', ['' => '', 'Sama dengan gambar' => 'Sama dengan gambar', 'Lebih besar' => 'Lebih besar', 'Lebih kecil' => 'Lebih kecil'], $data->PorsiBuah ?? '', ['class' => 'form-control', 'id' => 'PorsiBuah', 'required']); !!}
            </div>
            <div class="form-group mb-4">
                <label>Dalam satu minggu terakhir, berapa kali sehari Anda mengonsumsi sayur-sayuran?</label>
                <div class="input-group">
                    <input type="number" id="Sayur" name="Sayur" class="form-control" value="{{ $data->Sayur ?? '' }}" autocomplete="off" required>
                    <div class="input-group-append">
                        <span class="input-group-text">kali/hari</span>
                    </div>
                </div>
            ...
            <div class="form-group mb-4">
                ...
                <div class="mx-auto">
                    <img src="{{ url('img/assets/isi-piringku-sayuran.jpg') }}" alt="isi piringku porsi sayuran" class="mw-100" />
                </div>
                {!! Form::select('PorsiSayur', ['' => '', 'Sama dengan gambar' => 'Sama dengan gambar', 'Lebih besar' => 'Lebih besar', 'Lebih kecil' => 'Lebih kecil'], $data->PorsiSayur ?? '', ['class' => 'form-control', 'id' => 'PorsiSayur', 'required']); !!}
            </div>
            <div class="form-group mb-4">
                ...
                <div class="input-group">
                    <input type="number" id="ProteinHewani" name="ProteinHewani" class="form-control" value="{{ $data->ProteinHewani ?? '' }}" autocomplete="off" required>
                    <div class="input-group-append">
                        <span class="input-group-text">kali/hari</span>
                    </div>
                </div>
            ...
            <div class="form-group mb-4">
                ...
                <div class="input-group">
                    <input type="number" id="ProteinNabati" name="ProteinNabati" class="form-control" value="{{ $data->ProteinNabati ?? '' }}" autocomplete="off" required>
                    <div class="input-group-append">
                        <span class="input-group-text">kali/hari</span>
                    </div>
                </div>
            ...
            <div class="form-group mb-4">
                ...
                <div class="mx-auto">
                    <img src="{{ url('img/assets/isi-piringku-lauk-pauk.jpg') }}" alt="isi piringku porsi lauk pauk" class="mw-100" />
                </div>
                {!! Form::select('PorsiProtein', ['' => '', 'Sama dengan gambar' => 'Sama dengan gambar', 'Lebih besar' => 'Lebih besar', 'Lebih kecil' => 'Lebih kecil'], $data->PorsiProtein ?? '', ['class' => 'form-control', 'id' => 'PorsiProtein', 'required']); !!}
            </div>
