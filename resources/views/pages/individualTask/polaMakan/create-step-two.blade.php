...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{ route('polamakan.create.step.two.post') }}" method="POST">
            @csrf
            <div class="form-group mb-4">
                ...
                <div class="input-group mb-2">
                    <input type="number" id="SelainNasiHari" name="SelainNasiHari" class="form-control" value="{{ $data->SelainNasiHari ?? '' }}" autocomplete="off" required>
                    <div class="input-group-append">
                        <span class="input-group-text">kali/hari</span>
                    </div>
                </div>
                <div class="input-group">
                    <input type="number" id="SelainNasiMinggu" name="SelainNasiMinggu" class="form-control" value="{{ $data->SelainNasiMinggu ?? '' }}" autocomplete="off" required>
                    <div class="input-group-append">
            ...
            <div class="form-group mb-4">
                ...
                <div class="input-group">
                    <input type="number" id="MakananPokok" name="MakananPokok" class="form-control" value="{{ $data->MakananPokok ?? '' }}" autocomplete="off" required>
                    <div class="input-group-append">
                        <span class="input-group-text">kali/hari</span>
                    </div>
                </div>
            ...
            <div class="form-group mb-4">
                ...
                <div class="mx-auto">
                    <img src="{{ url('img/assets/isi-piringku-makanan-pokok.jpg') }}" alt="isi piringku porsi makanan pokok" class="mw-100" />
                </div>
                {!! Form::select('PorsiMakananPokok', ['' => '', 'Sama dengan gambar' => 'Sama dengan gambar', 'Lebih besar' => 'Lebih besar', 'Lebih kecil' => 'Lebih kecil'], $data->PorsiMakananPokok ?? '', ['class' => 'form-control', 'id' => 'PorsiMakananPokok', 'required']); !!}
            </div>
            <div class="form-group mb-4">
                <label>Dalam satu minggu terakhir, berapa kali Anda mengonsumsi cemilan manis atau minuman manis?</label>
                <div class="input-group mb-2">
                    <input type="number" id="CemilanManisHari" name="CemilanManisHari" class="form-control" value="{{ $data->CemilanManisHari ?? '' }}" autocomplete="off" required>
                    <div class="input-group-append">
                        <span class="input-group-text">kali/hari</span>
                    </div>
                </div>
                <div class="input-group">
                    <input type="number" id="CemilanManisMinggu" name="CemilanManisMinggu" class="form-control" value="{{ $data->CemilanManisMinggu ?? '' }}" autocomplete="off" required>
                    <div class="input-group-append">
                        <span class="input-group-text">kali/minggu</span>
                    </div>
                </div>
            ...
            <div class="form-group mb-4">
                ...
                <div class="input-group mb-2">
                    <input type="number" id="MinumanManisHari" name="MinumanManisHari" class="form-control" value="{{ $data->MinumanManisHari ?? '' }}" autocomplete="off" required>
                    <div class="input-group-append">
                        <span class="input-group-text">kali/hari</span>
                    </div>
                </div>
                <div class="input-group">
                    <input type="number" id="MinumanManisMinggu" name="MinumanManisMinggu" class="form-control" value="{{ $data->MinumanManisMinggu ?? '' }}" autocomplete="off" required>
                    <div class="input-group-append">
                        <span class="input-group-text">kali/minggu</span>
                    </div>
                </div>
            ...
            <div class="col-auto align-self-center  pl-0">
                <button type="button" onclick="window.location='{{ route("polamakan.create.step.one") }}'" class="btn btn-danger rounded">Kembali</button>
