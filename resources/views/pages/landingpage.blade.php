    ...
    <div class="flex flex-wrap donatur-list">
        ...
        <div class="w-full">
            <div class="flex items-center bg-white shadow-sm rounded-sm mb-2 px-4 py-4 rounded">
                ...
                <div class="text-sm">
                    <p class="text-gray-900 leading-none">{{ $row->Name }}</p>
                    ...
                    <p class="text-gray-500 text-xs italic">{{ $TimeSince[$key] }}</p>
                    <p class="text-gray-700 text-xs italic mt-2">"{{ $row->Message }}"</p>
                </div>
            </div>
        </div>
        @endforeach
