        ...
        <div class="md:container max-w-56rem md:px-4 mx-auto">
            <div class="flex">
                ...
                <div class="w-full md:w-1/2 text-right px-4 py-4 md:pt-4 md:px-0 mb:pb-0 sm:flex md:block">
                    ...
                    <a class="rounded bg-blue-500 hover:bg-blue-600 py-2 px-6 text-white text-center text-sm hidden md:inline-block pulse" href="{{ url('/donate') }}{{ $Referrer }}">Donasi Sekarang</a>
                </div>
</div>
    </div>
</div>
...
<a class="block rounded bg-blue-500 hover:bg-blue-600 py-8 text-white font-bold text-center text-2xl no-underline border-b-8 border-blue-700 uppercase pulse" href="{{ url('/donate') }}{{ $Referrer }}">Donasi Sekarang</a>
</div>
</div>
...
<a class="block flex-1 ml-2 rounded bg-blue-500 hover:bg-blue-600 py-2 text-sm text-white font-bold text-center border-b-2 border-blue-700 uppercase pulse" href="{{ url('/donate') }}{{ $Referrer }}">Donasi Sekarang</a>
</div>
</div></main>
