        ...
        <script type="text/javascript" src="{{ asset('files/assets/js/app.js')}}"></script>
        <script type="text/javascript" src="{{ asset('files/assets/js/jquery.validate.min.js')}}"></script>
        <script type="text/javascript" src="{{ asset('files/assets/js/jquery.dataTables.min.js')}}"></script>
