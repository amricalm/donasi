...
<nav class="pcoded-navbar">
    <div class="pcoded-inner-navbar main-menu">
        ...
        <ul class="pcoded-item pcoded-left-item">
            ...
            @for ($i=0; $i < count(Session::get('UserMenu')); $i++) <li class="{{ (!empty($aktif) && Session::get('UserMenu')[$i]['Name'] == $aktif) ? 'active' : ''}} {{ (count(Session::get('UserMenu')[$i]['child']) > 0) ? 'pcoded-hasmenu' : ''}}">
                ...
                <ul class="pcoded-submenu">
                    @for($j=0;$j<count(Session::get('UserMenu')[$i]['child']);$j++) <li class="{{(count(Session::get('UserMenu')[$i]['child'][$j]['child']) > 0) ? 'pcoded-hasmenu' : ''}}">
                        ...
                        <ul class="pcoded-submenu">
                            @for($k=0;$k<count(Session::get('UserMenu')[$i]['child'][$j]['child']);$k++) <li class="{{(count(Session::get('UserMenu')[$i]['child'][$j]['child'][$k]['child']) > 0) ? 'pcoded-hasmenu' : ''}}">
                                ...
                                <ul class="pcoded-submenu">
                                    @for($l=0;$l<count(Session::get('UserMenu')[$i]['child'][$j]['child'][$k]['child']);$l++) <li class="{{(count(Session::get('UserMenu')[$i]['child'][$j]['child'][$k]['child'][$l]['child']) > 0) ? 'pcoded-hasmenu' : ''}}">
                                        ...
                                        <ul class="pcoded-submenu">
                                            @for($m=0;$m<count(Session::get('UserMenu')[$i]['child'][$j]['child'][$k]['child'][$l]['child']);$m++) <li class="">
