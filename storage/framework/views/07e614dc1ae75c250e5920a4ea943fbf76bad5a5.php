...
<nav class="pcoded-navbar">
    <div class="pcoded-inner-navbar main-menu">
        ...
        <ul class="pcoded-item pcoded-left-item">
            ...
            <?php for($i=0; $i < count(Session::get('UserMenu')); $i++): ?> <li class="<?php echo e((!empty($aktif) && Session::get('UserMenu')[$i]['Name'] == $aktif) ? 'active' : ''); ?> <?php echo e((count(Session::get('UserMenu')[$i]['child']) > 0) ? 'pcoded-hasmenu' : ''); ?>">
                ...
                <ul class="pcoded-submenu">
                    <?php for($j=0;$j<count(Session::get('UserMenu')[$i]['child']);$j++): ?> <li class="<?php echo e((count(Session::get('UserMenu')[$i]['child'][$j]['child']) > 0) ? 'pcoded-hasmenu' : ''); ?>">
                        ...
                        <ul class="pcoded-submenu">
                            <?php for($k=0;$k<count(Session::get('UserMenu')[$i]['child'][$j]['child']);$k++): ?> <li class="<?php echo e((count(Session::get('UserMenu')[$i]['child'][$j]['child'][$k]['child']) > 0) ? 'pcoded-hasmenu' : ''); ?>">
                                ...
                                <ul class="pcoded-submenu">
                                    <?php for($l=0;$l<count(Session::get('UserMenu')[$i]['child'][$j]['child'][$k]['child']);$l++): ?> <li class="<?php echo e((count(Session::get('UserMenu')[$i]['child'][$j]['child'][$k]['child'][$l]['child']) > 0) ? 'pcoded-hasmenu' : ''); ?>">
                                        ...
                                        <ul class="pcoded-submenu">
                                            <?php for($m=0;$m<count(Session::get('UserMenu')[$i]['child'][$j]['child'][$k]['child'][$l]['child']);$m++): ?> <li class="">
