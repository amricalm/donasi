...
<div class="card">
    ...
    <div class="card-body">
        <form action="<?php echo e(route('polamakan.create.step.three.post')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <div class="form-group mb-4">
                ...
                <div class="input-group mb-2">
                    <input type="number" id="MinumanKemasanHari" name="MinumanKemasanHari" class="form-control" value="<?php echo e($data->MinumanKemasanHari ?? ''); ?>" autocomplete="off" required>
                    <div class="input-group-append">
                        <span class="input-group-text">kali/hari</span>
                    </div>
                </div>
                <div class="input-group">
                    <input type="number" id="MinumanKemasanMinggu" name="MinumanKemasanMinggu" class="form-control" value="<?php echo e($data->MinumanKemasanMinggu ?? ''); ?>" autocomplete="off" required>
                    <div class="input-group-append">
            ...
            <div class="form-group mb-4">
                ...
                <div class="input-group">
                    <input type="number" id="CemilanAsin" name="CemilanAsin" class="form-control" value="<?php echo e($data->CemilanAsin ?? ''); ?>" autocomplete="off" required>
                    <div class="input-group-append">
            ...
            <div class="form-group mb-4">
                ...
                <div class="input-group">
                    <input type="number" id="Gorengan" name="Gorengan" class="form-control" value="<?php echo e($data->Gorengan ?? ''); ?>" autocomplete="off" required>
                    <div class="input-group-append">
            ...
            <div class="form-group mb-4">
                ...
                <div class="input-group">
                    <input type="number" id="Sarapan" name="Sarapan" class="form-control" value="<?php echo e($data->Sarapan ?? ''); ?>" autocomplete="off" required>
                    <div class="input-group-append">
                        <span class="input-group-text">kali</span>
                    </div>
                </div>
            ...
            <div class="form-group mb-4">
                ...
                <div class="mx-auto">
                    <img src="<?php echo e(url('img/assets/air-195ml.jpg')); ?>" alt="Air Putih" class="mw-100" />
                </div>
                <div class="input-group">
                    <input type="number" id="AirPutih" name="AirPutih" class="form-control" value="<?php echo e($data->AirPutih ?? ''); ?>" autocomplete="off" required>
                    <div class="input-group-append">
            ...
            <div class="form-group mb-4">
                ...
                <?php echo Form::select('LabelKemasan', ['' => '', 'Ya' => 'Ya', 'Tidak' => 'Tidak'], $data->LabelKemasan ?? '', ['class' => 'form-control', 'id' => 'LabelKemasan', 'required']);; ?>

            </div>
            <div class="col-auto align-self-center  pl-0">
                <button type="button" onclick="window.location='<?php echo e(route("polamakan.create.step.two")); ?>'" class="btn btn-danger rounded">Kembali</button>
