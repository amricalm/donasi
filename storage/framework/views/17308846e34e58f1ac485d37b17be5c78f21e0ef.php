                    ...
                    <div class="program-collected my-4">
                        ...
                        <div class="p-card__count mt-1">
                            <div class="p-card__countitem">
                                <div class="p-card__stats"><span class="text-xs md:text-xl color-gray">Donasi</span><span class="font-bold text-black text-sm md:text-3xl"><?php echo e($CountDonations->Donate); ?></span></div>
                            </div>
...
<div id="tab-donatur" class="tab-pane">
    <h3 class="md:hidden mb-5 text-xl font-bold">Donatur (<?php echo e($CountDonations->Donate); ?>)</h3>
