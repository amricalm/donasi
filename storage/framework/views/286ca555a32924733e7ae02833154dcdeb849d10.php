        ...
        <form action="<?php echo e(route('individualtask.create.step.four.post')); ?>" method="POST">
            ...
            <div class="form-group mb-4">
                ...
                <div class="input-group">
                    <input type="number" id="JumlahAnak" name="JumlahAnak" class="form-control" value="<?php echo e($data->JumlahAnak ?? ''); ?>">
            ...
            <div class="form-group mb-4">
                ...
                <input type="text" id="UsiaBaduta" name="UsiaBaduta" class="form-control" value="<?php echo e($data->UsiaBaduta ?? ''); ?>">
            </div>
            <div class="form-group mb-4">
            ...
            <div class="form-group mb-4">
                ...
                <input type="text" id="LamaAsiBaduta" name="LamaAsiBaduta" class="form-control" value="<?php echo e($data->LamaAsiBaduta ?? ''); ?>">
            </div>
            <div class="form-group mb-4">
                <label>Apakah anda memerah ASI?</label>
                <input type="text" id="MemerahAsi" name="MemerahAsi" class="form-control" value="<?php echo e($data->MemerahAsi ?? ''); ?>">
            </div>
            <div class="form-group mb-4">
                <label>Dimana anda memerah ASI</label>
                <input type="text" id="TempatMemerahAsi" name="TempatMemerahAsi" class="form-control" value="<?php echo e($data->TempatMemerahAsi ?? ''); ?>">
            </div>
            <div class="form-group mb-4">
            ...
            <div class="form-group mb-4">
                ...
                <input type="text" id="HambatanMemerahAsi" name="HambatanMemerahAsi" class="form-control" value="<?php echo e($data->HambatanMemerahAsi ?? ''); ?>">
            </div>
            <div class="form-group mb-4">
            ...
            <div class="form-group mb-4">
                ...
                <input type="text" id="UsiaDiberiSusu" name="UsiaDiberiSusu" class="form-control" value="<?php echo e($data->UsiaDiberiSusu ?? ''); ?>">
            </div>
            <div class="form-group mb-4">
