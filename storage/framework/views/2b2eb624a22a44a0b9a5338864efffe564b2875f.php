        ...
        <main class="py-4">
            <section class="login-block">
                <div class="container">
                    <div class="row">
                        <div class="col-sm-12">
                            <form class="md-float-material form-material" method="POST" id="frm" action="<?php echo e(url('admin-login/validasi')); ?>" role="form" onsubmit="return submited()">
                            <?php echo csrf_field(); ?>
                                <div class="auth-box card">
                                    <div class="card-block">
                                        ...
                                        <div class="form-group form-primary<?php echo e($errors->has('email') ? ' has-error' : ''); ?> form-static-label">
                                            <input id="email" type="text" name="username" class="form-control" autocomplete="off" placeholder="No Handphone atau Alamat Email" required>
                                        ...
                                        <div class="form-group form-primary<?php echo e($errors->has('password') ? ' has-error' : ''); ?> form-static-label">
                                            <input id="password" type="password" name="password" class="form-control<?php echo e($errors->has('password') ? ' is-invalid' : ''); ?>" placeholder="Password" required="">
                                        ...
                                        <div class="row m-t-30">
                                            <div class="col-md-12">
                                                ...
                                                <p class="text-center">Belum punya akun? <a class="text-primary" href="<?php echo e(url('/register')); ?>">Daftar segera.</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
