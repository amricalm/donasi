...
<div class="mb-4 mx-auto">
    <div class="flex flex-wrap">
        ...
        <span class="text-black truncate text-sm">Selesaikan pembayaran donasi sebelum <span class="font-bold">besok</span> jam <span class="font-bold"><?php echo e($MaxConfDate); ?></span></span>
        </div>
    </div>
</div>
<div class="card">
    ...
    <div class="j-content">
        <div class="j-unit">
            ...
            <div class="text-center mt-2">
                ...
                <h2 class="font-semibold text-black mb-4"><?php echo e($donate->Invoice); ?></h2>
            </div>
