...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-10">
            <form action="<?php echo e(route('products.create.step.three.post')); ?>" method="post" >
                    ...
                    <div class="card-footer">
                        <div class="row">
                            <div class="col-md-6 text-left">
                                <a href="<?php echo e(route('products.create.step.two')); ?>" class="btn btn-danger pull-right">Previous</a>
                            </div>
