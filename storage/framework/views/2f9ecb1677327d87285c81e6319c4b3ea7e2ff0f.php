    ...
    <div class="j-content">
        <div class="j-unit">
                    ...
                    <div class="form-group input-amount mt-2">
                        ...
                        <input type="text" class="form-control bg-orange-100 focus:bg-white text-right amount pl-10 h-57px text-black border-orange-200 focus:border-orange-600" name="amount" id="amount-input-last" placeholder="0" data-mask="000.000.000.000.000" data-mask-reverse="true" autocomplete="off" maxlength="19" required="required" value="<?php echo e($nominal); ?>">
                    </div>
                    ...
                    <div class="donate-form-login">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control focus:bg-white text-black border-orange-200 focus:border-orange-600 text-sm h-57px bg-orange-100 placeholder-gray-500" name="name" required="" placeholder="Nama lengkap" value="">
                        ...
                        <div class="form-group mb-6">
                            ...
                            <input type="number" class="form-control focus:bg-white text-black border-orange-200 focus:border-orange-600 text-sm h-57px bg-orange-100 placeholder-gray-500" name="phone" required="" placeholder="Tuliskan No. Handphone aktif anda" value="">
                        </div>
                        <div class="form-group mb-6">
