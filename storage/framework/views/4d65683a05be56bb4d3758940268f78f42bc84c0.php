...
<div class="card">
    ...
    <div class="card-body">
        <form action="<?php echo e(route('kespro.create.step.two.post')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            ...
            <div class="col-auto align-self-center  pl-0">
                <button type="button" onclick="window.location='<?php echo e(route("kespro.create.step.one")); ?>'" class="btn btn-danger rounded">Kembali</button>
