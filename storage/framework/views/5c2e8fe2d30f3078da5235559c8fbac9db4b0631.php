                                        ...
                                        <div class="col-sm-12">
                                            <div class="card">
                                                ...
                                                <div class="card-block">
                                                    <form method="post" id="form" action="<?php echo e(url('program/saveprogress')); ?>" class="form-material" enctype="multipart/form-data">
                                                    <?php echo e(csrf_field()); ?>

                                                        <input type="hidden" name="ProgramID" value="<?php echo e($ProgramByID->ID); ?>">
                                                        ...
                                                        <div class="form-group form-primary form-static-label">
                                                            <input name="ProgressDate" id="dropper-animation" class="form-control tanggal" type="text" autocomplete="off" />
                                                            <span class="form-bar"></span>
...
<script type="text/javascript">
    $( document ).ready(function() {
        $(document).delegate("#simpan","click",function(){
            ...
            $.ajax({
                url:"<?php echo e(url('program/saveprogress')); ?>",
                type: "POST",
                data: formData,
                processData: false,
                contentType: false,
                success: function(hasil) {
                    ...
                    { 
                        ...
                        window.location = '<?php echo e(url('program/progresslist').'/'.$ProgramByID->ID); ?>';
                    }
                },
