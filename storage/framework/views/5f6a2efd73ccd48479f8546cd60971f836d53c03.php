...
<div class="bg-white">
    <div class="container max-w-56rem px-1 pb-6 px-4 md:pb-10 md:pt-10 mx-auto"><figure class="program-cover progressive mb-5 overflow-hidden">
        <img src="<?php echo e(url('img/banner/banner-qoryah-quran.jpg')); ?>" data-src="<?php echo e(url('img/banner/banner-qoryah-quran.jpg')); ?>?ar=16:9&amp;w=720&amp;fit=crop&amp;auto=format,compress" alt="Gotong Royong Bangun Pesantren Hafizh Al Quran"><noscript>
        <img src="<?php echo e(url('img/banner/banner-qoryah-quran.jpg')); ?>?ar=16:9&amp;w=720&amp;fit=crop&amp;auto=format,compress" alt="Cover Gotong Royong Bangun Pesantren Hafizh Al Quran"/></noscript></figure><h1 class="text-lg sm:text-xl md:text-3xl font-bold text-gray-800 leading-normal">Gotong Royong Bangun Pesantren Hafizh Al Quran</h1>
        <div class="program-head">
            ...
            <div class="w-full py-2 md:py-4">
                ...
                <div id="cta-donate" class="program-cta py-2 mt-2">
                    <a class="block rounded bg-blue-500 hover:bg-blue-600 py-4 md:py-8 text-white font-bold text-center text-sm md:text-2xl border-b-4 border-blue-700 uppercase pulse" href="<?php echo e(url('/donate')); ?>">Donasi Sekarang</a>
                </div>
                <div class="program-author rounded mt-6 border-custom bg-gray-100 p-4"><h3 class="text-sm text-gray-700 mb-2">Pemilik Program</h3>
                    <div class="flex items-center">
                        <img class="w-8 h-8 md:w-12 md:h-12 mr-4" src="<?php echo e(asset('js/landingpage/xfmMTejjvOEZpVNuEseYF4DwX5ZFatGxuXAx5sKS.png')); ?>" alt="Avatar Program Badan Wakaf Al Quran">
                        <div>
            ...
            <div class="flex">
                ...
                <div class="w-full md:w-1/2 text-right px-4 py-4 md:pt-4 md:px-0 mb:pb-0 sm:flex md:block">
                    ...
                    <div class="w-full sm:w-1/2 md:w-auto md:inline-block">
                        <a class="border border-blue-800 block sm:float-right md:float-none md:px-4 mr-2 mt-1 px-2 py-2 rounded share-link-popup text-blue-800 text-center text-xs md:text-sm" href="https://www.facebook.com/sharer/sharer.php?u=https:<?php echo e(url('/')); ?>">
                    ...
                    <a class="rounded bg-blue-500 hover:bg-blue-600 py-2 px-6 text-white text-center text-sm hidden md:inline-block pulse" href="<?php echo e(url('/donate')); ?>">Donasi Sekarang</a>
                </div>
</div>
    </div>
</div>
...
<img src="<?php echo e(asset('js/landingpage/Z5nFpx3h8WKHE94oj0Nk1KgMXgZ7FCCixZSZ6e1x.jpeg')); ?>"></figure>
...
<img class="w-10 h-10 rounded-full mr-4 border border-gray-500" src="<?php echo e(asset('js/landingpage/Nndy4VSOfk0EaRJhC2qfxIUPC8J7VKA7ItQGkq0g.png')); ?>" alt="Avatar of Pendekar Wakaf">
                    <div class="text-sm">
...
<img src="<?php echo e(asset('js/landingpage/KdUJvM996vwfRjN5itl1b1ljbxvClQdfdiBPNTDb.jpeg')); ?>?ar=16:9&amp;w=720&amp;auto=format,compress"></figure>
<p><br></p>
...
<p></p><figure>
<img src="<?php echo e(asset('js/landingpage/r4MdmTmjkWaCwcXg4RNPytWCVN1TGQj1z423hq1L.jpeg')); ?>?ar=16:9&amp;w=720&amp;auto=format,compress"></figure>
<p></p><figure>
<img src="<?php echo e(asset('js/landingpage/0wu6Py0pu62fLOOLJLS1n1nIJZx7C82J16cSfYFA.jpeg')); ?>?ar=16:9&amp;w=720&amp;auto=format,compress"></figure>
<p></p><figure>
<img src="<?php echo e(asset('js/landingpage/VygSPwVtkgrxaKnz5H14NM6tUdb7qyOVnXFE4dIo.jpeg')); ?>?ar=16:9&amp;w=720&amp;auto=format,compress"></figure><figure>
<img src="<?php echo e(asset('js/landingpage/wzwhfvMwQkmvJVPFtYI2AuydnjrFxlmWrRHymu8x.jpeg')); ?>?ar=16:9&amp;w=720&amp;auto=format,compress"></figure>
<p></p>
...
<figure>
<img src="<?php echo e(asset('js/landingpage/6UbQjxuPioyFPfZjllDUWaR3eg1zJGnwdVpK2I5G.jpeg')); ?>?ar=16:9&amp;w=720&amp;auto=format,compress"></figure>
<p><br></p>
...
<figure>
<img src="<?php echo e(asset('js/landingpage/h0GZILVeH6AuYBriBpge4i2ZgT2hLvYYziynAavL.jpeg')); ?>?ar=16:9&amp;w=720&amp;auto=format,compress"></figure>
<p>Sisa pekerjaan:</p>
...
<a class="block flex-1 ml-2 rounded bg-blue-500 hover:bg-blue-600 py-2 text-sm text-white font-bold text-center border-b-2 border-blue-700 uppercase pulse" href="<?php echo e(url('/donate')); ?>">Donasi Sekarang</a>
</div>
</div></main>
