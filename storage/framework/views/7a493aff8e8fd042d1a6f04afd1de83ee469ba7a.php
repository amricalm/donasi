        ...
        <header id="header" class="bg-header">
            <nav class="flex items-center px-2 py-2 text-center">
                <a href="/" class="mx-auto">
                    <img class="h-6" src="<?php echo e(url('img/logo.png')); ?>">
                </a>
            </nav>
        </header>
        <main>
            <section class="login-block">
                <div class="container">
                    <div class="row">
                        <div class="col-sm-12">
                            <form class="md-float-material form-material" method="POST" id="frm" action="<?php echo e(url('register/validation')); ?>" role="form" onsubmit="return submited()">
                            <?php echo e(csrf_field()); ?>
                                ...
                                <div class="auth-box card">
                                    <div class="card-block">
                                        ...
                                        <div class="form-group form-primary form-static-label <?php echo e($errors->has('name') ? 'has-error' : ''); ?>">
                                        ...
                                        <div class="form-group form-primary form-static-label <?php echo e($errors->has('name') ? 'has-error' : ''); ?>">
                                            <input type="Email" id="email" name="email" class="form-control" autocomplete="off" value="<?php echo e(old('email')); ?>" required>
                                            <label class="float-label">Email</label>
                                            <?php if($errors->has('email')): ?>
                                                <span class="text-danger"><?php echo e($errors->first('email')); ?></span>
                                            <?php endif; ?>
                                        </div>
                                        <div class="form-group form-primary form-static-label <?php echo e($errors->has('phone') ? 'has-error' : ''); ?>">
                                            <input type="number" id="phone" name="phone" class="form-control" autocomplete="off" value="<?php echo e(old('phone')); ?>" required>
                                        ...
                                        <div class="form-group">
                                            <div class="row m-t-30">
                                                <div class="col-md-12">
                                                    ...
                                                    <p class="text-center">Sudah punya akun? <a class="text-primary" href="<?php echo e(url('/login')); ?>"> Login di sini.</a></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
