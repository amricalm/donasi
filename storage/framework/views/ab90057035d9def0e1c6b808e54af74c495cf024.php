    ...
    <div class="card-body">
        <form action="<?php echo e(route('individualtask.create.step.one.post')); ?>" method="POST">
            ...
            <div class="form-group mb-4">
                ...
                <input type="text" id="TglMasuk" name="TglMasuk" class="form-control" value="<?php echo e($data->TglMasuk ?? ''); ?>" autocomplete="off">
            </div>
            <div class="form-group mb-4">
                <label>Tahun mulai kerja di sub unit :</label>
                <input type="text" id="TglMasukUnit" name="TglMasukUnit" class="form-control" value="<?php echo e($data->TglMasukUnit ?? ''); ?>" autocomplete="off">
            </div>
            <div class="form-group mb-4">
