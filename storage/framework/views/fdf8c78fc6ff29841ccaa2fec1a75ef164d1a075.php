...
<form class="j-pro" method="post">
            <div class="card-payment p-0">
                ...
                <?php $__currentLoopData = $bank; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="javascript:Confirmation(<?php echo e($row->ID); ?>);" class="pt-3 pr-3 pb-0 pl-3 block hover:bg-blue-100 select-type" data-type="<?php echo e($row->Type); ?>" data-label="<?php echo e($row->Label); ?>" data-image="<?php echo e(url('img/payments/'.$row->Image)); ?>">
